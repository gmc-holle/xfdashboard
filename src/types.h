...
typedef enum /*< prefix=XFDASHBOARD_BACKGROUND_TYPE >*/
{
	...
	XFDASHBOARD_BACKGROUND_TYPE_FILL_ROUNDED,

	XFDASHBOARD_BACKGROUND_TYPE_OUTLINE,
	XFDASHBOARD_BACKGROUND_TYPE_OUTLINE_ROUNDED,

	XFDASHBOARD_BACKGROUND_TYPE_FILL_OUTLINE,
	XFDASHBOARD_BACKGROUND_TYPE_FILL_OUTLINE_ROUNDED,
